...
const CommentCard = ({comment}: CommentProps) => {
    return (
        <div className="flex flex-col gap-y-(--sp-200) md:gap-y-(--sp-300)">
            <div className="relative flex flex-col-reverse lg:flex-row bg-(--clr-white) gap-y-(--sp-200) lg:gap-x-(--sp-300) p-(--sp-200) lg:p-(--sp-300) rounded-lg w-full h-auto lg:w-fit lg:h-[10.4375rem]">
            ...
            <div className="flex flex-col gap-y-(--sp-200) md:gap-y-(--sp-300) border-l-2 border-(--clr-grey-100) pl-(--sp-200) md:pl-(--sp-500) md:ml-[2.87rem]">
