...
interface CommentCardReplyFieldProps {
    commentId: number;
    setShowCommentReplyField: React.Dispatch<React.SetStateAction<boolean>>;
}

const CommentCardReplyField = ({
    commentId,
    setShowCommentReplyField,
}: CommentCardReplyFieldProps) => {
    const {replyComment} = useCommentsStore();
    ...
    const handleReplyComment = () => {
        ...
        replyComment(commentId, commentText.trim());
        setCommentText('');
        setShowCommentReplyField(false);
    };
...
export default CommentCardReplyField;
